...
class ReportMerger {
     ...
     * @throws Exception
     */
    public void mergeReports(File reportDirectory) throws IOException {
    ...
    private void mergeResponse(File reportDirectory, String format, String reportFileName) throws IOException {
        System.err.println("In ReportMerger--->Report directory: " + reportDirectory + "  File format: " + format + "  Report fileName: " + reportFileName);
